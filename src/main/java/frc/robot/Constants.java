...
public final class Constants {
    ...
    public static final double SHOOTER_LOW_SPEED_LEFT = -0.3;
    public static final double SHOOTER_LOW_SPEED_RIGHT = -0.3;
    public static final double SHOOTER_MEDIUM_SPEED_LEFT = -0.35;
    public static final double SHOOTER_MEDIUM_SPEED_RIGHT = -0.35;
